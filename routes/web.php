...
////// API Raja Ongkir ///////////
Route::get('delivery/getprovince', 'DeliveryController@getprovince');
Route::get('delivery/getcity', 'DeliveryController@getcity');
Route::get('delivery/checkshipping', 'DeliveryController@checkshipping');
Route::post('delivery/processShipping', 'DeliveryController@processShipping');
...
Route::group(['middleware'=>'FrontLogin_middleware'],function (){
    ...
    Route::get('/banktransfer','OrdersController@banktransfer');
});
///
...
Route::group(['prefix'=>'admin','middleware'=>['auth','admin']],function (){
    ...
    /// ///////// Orders Area //////////
    Route::resource('/order','ListordersController');
    Route::get('/status/update', 'ListordersController@changestatus')->name('users.update.status');
    Route::get('changestatus','ListordersController@changestatus');
    Route::get('delete-order/{id}','ListordersController@destroy');
    /// ///////// Users Area //////////
    Route::resource('/user','ListusersController');
    Route::get('delete-user/{id}','ListusersController@destroy');
///
});
